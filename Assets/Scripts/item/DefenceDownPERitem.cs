...
public class DefenceDownPERitem: MonoBehaviour
{

    public float effect_time;
    public float effect_defencedown_percent;
    // 判定済みオブジェクトを格納するリスト
    ...
    private void ExecuteFunction(GameObject enemyObject)
    {
        ...
        DefenseDecreasepercentEffect effect = enemyObject.AddComponent<DefenseDecreasepercentEffect>();
        effect.ApplyEffect(effect_time, effect_defencedown_percent);
    }
}
