...
public class PowerDownitem: MonoBehaviour
{

    public float effect_time;
    public float effect_attackdown_value;
    // 判定済みオブジェクトを格納するリスト
    ...
    private void ExecuteFunction(GameObject enemyObject)
    {
        ...
        AttackDecreaseEffect effect = enemyObject.AddComponent<AttackDecreaseEffect>();
        effect.ApplyEffect(effect_time, effect_attackdown_value);
    }
}
