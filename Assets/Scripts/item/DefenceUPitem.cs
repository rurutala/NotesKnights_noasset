...
public class DefencerUPitem: MonoBehaviour
{

    public float effect_time;
    public float effect_defenceup_value;
    // 判定済みオブジェクトを格納するリスト
    ...
    private void ExecuteFunction(GameObject playerObject)
    {
        ...
        DefenseIncreaseEffect effect = playerObject.AddComponent<DefenseIncreaseEffect>();
        effect.ApplyEffect(effect_time, effect_defenceup_value);
    }
}
